window.onload=function(){
    ...
    function handlers1() {
        ...
        $(document).delegate("mousedown touchstart", ".s-path", function(e) {
        ...
        $(document).delegate("mouseup touchend", function() {
    ...
    $(document).delegate("click", ".contact", function(e) {
        if (animating) return;
        animating = true;
        $(document).off("click", closeSidebar);
        var that = this,
    ...
    $(document).delegate("click", ".chat__back", function() {
        if (animating) return;
        animating = true;
        $chat.removeClass("active");
        $(".cloned").addClass("removed");
